...
public class ReINDeerAlgorithm {
	...
	protected void print() throws InputGenerationException, InputIterationException, AlgorithmConfigurationException {
	...
	protected void outputSomething() throws CouldNotReceiveResultException, ColumnNameMismatchException {
