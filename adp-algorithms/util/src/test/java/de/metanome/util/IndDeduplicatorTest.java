...
public class IndDeduplicatorTest {
    ...
    public void test4ary() {
        ...
        InclusionDependency ind = new InclusionDependency(new ColumnPermutation(c4, c12, c1, c5), new ColumnPermutation(d3, d1, d4, d1));
        Set<InclusionDependency> expectedInds = ImmutableSet.of(
                new InclusionDependency(new ColumnPermutation(c4, c1, c5), new ColumnPermutation(d3, d4, d1)),
                new InclusionDependency(new ColumnPermutation(c4, c12, c1), new ColumnPermutation(d3, d1, d4)));
    ...
    public void testScopExample() {
        ...
        Set<InclusionDependency> inds = ImmutableSet.of(
                ...
                new InclusionDependency(new ColumnPermutation(c4, c12, c1, c5), new ColumnPermutation(d3, d1, d4, d1)));
        Set<InclusionDependency> expectedInds = ImmutableSet.of(
                new InclusionDependency(new ColumnPermutation(c10, c4), new ColumnPermutation(d1, d3)),
                new InclusionDependency(new ColumnPermutation(c11, c4), new ColumnPermutation(d1, d3)),
                new InclusionDependency(new ColumnPermutation(c4, c9), new ColumnPermutation(d3, d1)),
