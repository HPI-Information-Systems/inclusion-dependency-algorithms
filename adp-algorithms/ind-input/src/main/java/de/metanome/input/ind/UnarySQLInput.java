...
import de.metanome.algorithms.unarysql.Configuration;
import de.metanome.algorithms.unarysql.UnarySQL;
import java.util.List;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
class UnarySQLInput implements InclusionDependencyInput {
